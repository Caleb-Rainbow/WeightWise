...
@Database(version = 7, entities = [Record::class, DailyPlan::class, ExerciseCompletion::class, Journey::class, Phase::class, DietRecord::class], exportSchema = true, autoMigrations = [AutoMigration(from = 1, to = 2), AutoMigration(from = 2, to = 3), AutoMigration(from = 3, to = 4), AutoMigration(from = 4, to = 5), AutoMigration(from = 5, to = 6), AutoMigration(from = 6, to = 7)])
